...
import { DateRange, NavigationAction, DefinedRange, Marker, MARKERS } from '../types'
...
const DateRangePicker: React.FunctionComponent<DateRangePickerProps> = (
    ...
    const resetDateRange = (a: any, b: any) => {
        if (!a && !b) {
    ...
    const inHoverRange = (day: Date) =>
        (startDate &&
            ...
            isWithinInterval(day, { end: hoverDay, start: startDate })) as boolean
